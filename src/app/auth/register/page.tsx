...
import { RegisterForm } from '@/app/components/auth/form-register';
            ...
            <div className="w-full flex items-center flex-col max-w-lg">
                ...
                <div className='flex flex-col gap-4 mt-8 mb-8'>
                    <div className="flex items-center justify-center gap-4">
                        <span className="text-[#90A3BF] text-center text-[16px] font-normal leading-[24px]">Atau daftar menggunakan</span>
                    </div>
